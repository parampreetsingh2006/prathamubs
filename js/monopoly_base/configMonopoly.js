...
"EnterLanguagePage":[
        ...
        },
        {
            ...
            "style": "position:absolute; width:70%;padding:10px;border-radius:5px;top:50%;margin-left:15%; background-color:black;"
        },
        {
            "templateId":2,
            "templateType":"static",
...
"WelcomePage":[
  ...
  },
  {
        ...
        "src":"<button onclick=\"monopoly.renderPageforBoard(monopoly.pages.EnterLanguagePage);\" style=\"position:absolute;padding:10px; border-radius:5px;top:82%;right:45%;padding:10px; background-image: url(images/backbutton.png);background-size: 100% 100%;background-color:transparent; padding: 2% 4%;    color: red;\" > </button>",
    },
    {
        "templateId":2,
        "templateType":"static",
