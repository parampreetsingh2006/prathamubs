...
'                    <div class="confirmButton mainButtons" id="target_cancel" onclick="ubsApp.closeCurrentScenario(); ubsApp.nextMove()">{{noThanksTitle}}</div>'+
...
ubsApp.advantageCardTemplate='<div style="{{style}}">'+
                          ...
                          '                </div>'+
                           ...
                           '                 <div style="cursor:pointer; float: left; background-image: url(images/buttonMedium.png);background-size: 100% 100%;width: fit-content;margin: auto;    padding: 7px; color: red;font-weight: bold;font-size: large; width: 16%;text-align: center;padding-bottom: 15%;padding-right: 15%;" onclick="ubsApp.closeCurrentScenario()" >{{CANCEL}}</div>'+
...
ubsApp.popUpTemplate = '<div style="{{style}};{{#if showBorder}}background-image: url(images/redbgcommon.png);{{/if}}" >'+
                       '    <div style="background-color: {{backgroundColor}};position: relative; min-height:10vh;max-height: 60vh;overflow: auto;   ">'+
                       ''+
                       '        <div>'+
                       ''+
                       ...
                       '                {{#each buttons}}'+
                       '                <div id= "{{id}}" style="cursor:pointer;    float: left;margin-right: 10px;background-image: url(images/buttonMedium.png);background-size: 100% 100%;width: fit-content; padding: 7px; color: red; font-weight:bold" onclick="{{action}}" >{{name}}'+
                       '                </div>'+
                       '                {{/each}}'+
                       '            </div>'+
                       ''+
