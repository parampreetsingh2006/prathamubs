...
monopoly.endGameTemplate = '<div style="'+
                           ...
                           '</div>'+
                           ''+
                           '    <div style="margin-top: 10px;margin-bottom: 10px;"> <div style="cursor:pointer;background-image: url(images/buttonMedium.png);background-size: 100% 100%; width: fit-content;margin: auto;   padding: 7px;    color: red;" onClick="ubsApp.restartGame();"> {{PLAYAGAIN}} </div></div>'+
                           '</div>';
