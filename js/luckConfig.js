ubsApp.luckConfig={
	...
	"luckyUnluckyScenario11":{
		...
		"templates":[
		{
			...
			// "value":-1800,
			// "type":"inventory",
			"credit":{"insurance":"yes","inventory":-7800},
			"quizType":"luck",
			"negative":"true",
			"quizRequired":true,
			"resultPage":"quizQ2",
	...
	"luckyUnluckyScenario22":{
		...
		"templates":[
		{
			...
			// "value":-1800,
			// "type":"inventory",
			"credit":{"balance":8700,"reputation":20},
			"quizType":"luck",
			"resultPage":"quizQ3",
			"scenarioTitle":"{{pratham_title_luck}}",
			"helpTitle":"{{helpTitle}}",
